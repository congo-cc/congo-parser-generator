...
public final class Main {
    ...
    static void usage() {
        ...
        System.out.println(" -jdkN             Specify the target JDK version. N is a number from 8 to 22. (Default is 8)");
            ...
            if (arg.charAt(0) == '-') {
                ...
                if (arg.equalsIgnoreCase("-p")) {
                    ...
                    if (jdkTarget <8 || jdkTarget > 22) {
                        System.err.println("The JDK Target currently must be between 8 and 22.");
                    }
                }
                else {
