...
public class ${settings::baseTokenClassName} ${implements} {
    ...
    #endif
    {
        #list lexerData::regularExpressions as regexp
          ${regexp::label}
            ...
            ("${regexp::literalString.JavaStringEncode}", true, ${regexp::ignoreCase ? "true" : "false"})
          #elseif regexp::class::simpleName == "RegexpStringLiteral"
            ("${regexp::literalString.JavaStringEncode}"${regexp::ignoreCase ? ", false, true" : ""})
          #endif
          ,
        #endlist
 ...
 [#-- If tree building is enabled, we can simply use the default
   ...
   @Override
    ...
    protected ${settings::baseTokenClassName}(TokenType type, TokenSource tokenSource, int beginOffset, int endOffset) {
        this.type = type;
        this.tokenSource = tokenSource;
        this.beginOffset = beginOffset;
        this.endOffset = endOffset;
     ...
     * a XXXLexer object.
     */
    public static ${settings::baseTokenClassName} newToken(TokenType type, String image) {
        ${settings::baseTokenClassName} result = newToken(type);
   ...
   public char charAt(int offset) {
      if (cachedImage != null) return cachedImage.charAt(offset);
          ...
          return ts != null ? ts.charAt(scanTo)
