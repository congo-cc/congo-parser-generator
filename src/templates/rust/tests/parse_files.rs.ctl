[#-- tests/parse_files.rs.ctl: Integration test harness that parses sample files.
     Recursively finds files matching the grammar's test extension in the
     test-data directory and verifies each one parses without error.
