...
import org.parsers.rust.RustParser;
import org.parsers.rust.Node;

/**
 * A test harness for parsing Rust files from the command line.
 */
public class RParse {
...
//        }
    ...
    static public void usage() {
        System.out.println("Usage: java RParse <sourcefiles or directories>");
        System.out.println("If you just pass it one Rust source file, it dumps the AST");
