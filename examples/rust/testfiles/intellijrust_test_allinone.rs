...
fn main() {
    ...
    r = 1.. ;
    r =  .. ;
    r = {1}..{2}; // Tricky case now working (JR)
    //r = 1...10;
    //r = 1 ... 10;
    //r = ... 10;
    r = 1..=10;
...
// This is syntactically valid, but semantically invalid because of the lifetime parameter (AI)
// According to the Rust reference this does not look valid even syntactically. (JR)
// Commented out for now, but may revisit. (JR)
