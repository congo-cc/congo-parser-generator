...
import org.parsers.test.Node;
import org.parsers.test.CardTestsParser;

/**
 * A test harness for parsing Cics source code
  */
public class CardTestsParse {
   ...
   static public void parseFile(File file, boolean dumpTree) throws IOException {
       CardTestsParser parser = new CardTestsParser(file.toPath());
   ...
   static public void usage() {
       System.out.println("Usage: java CardTestsParse <sourcefiles or directories>");
