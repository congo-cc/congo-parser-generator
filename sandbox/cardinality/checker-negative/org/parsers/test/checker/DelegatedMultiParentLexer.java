/* Generated by: CongoCC Parser Generator. DelegatedMultiParentLexer.java  */
...
public class DelegatedMultiParentLexer extends TokenSource { 
    ...
    public DelegatedMultiParentLexer(CharSequence input) { 
        this("input", input);
    }
    ...
    */
    public DelegatedMultiParentLexer(String inputSource, CharSequence input) { 
    ...
    * usages this is 1.
    */
    public DelegatedMultiParentLexer(String inputSource, CharSequence input, LexicalState lexState, int startingLine, int startingColumn) { 
    ...
    * called by DelegatedMultiParentParser.
    ...
    */
    public Token getNextToken(Token tok, EnumSet<TokenType> activeTokenTypes) { 
        ...
        // throw it away and go back to the DelegatedMultiParentLexer
